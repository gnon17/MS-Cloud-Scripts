...
$params = @{
	...
	displayName = "Unmanaged Windows MAM - Edge"
	...
	periodOfflineBeforeAccessCheck = "PT10080M"
	periodOfflineBeforeWipeIsEnforced = "P45D"
...
@{
target = @{
groupId = "8a377a26-feb4-4373-a18d-19b402e1e732"
...
New-MgBetaDeviceAppManagementWindowsManagedAppProtection -BodyParameter $params
